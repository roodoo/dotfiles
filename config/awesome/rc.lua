...
--    i dont like these because i use them too much in web browsers
--    awful.key({ modkey,           }, "Left",   awful.tag.viewprev       ),
--    awful.key({ modkey,           }, "Right",  awful.tag.viewnext       ),

-- these are for me lock screen
		...
		--
-- these are for the volume control knob
...
-- these are for me to edit my rc.lua
